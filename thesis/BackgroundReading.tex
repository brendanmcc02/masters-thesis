...
\label{section:guidance-counsellors}
...
\section{Common RS algorithms}
\label{sec:common-rs-algorithms}

\textbf{TODO} - only talk about RS algorithms that are relevant!
