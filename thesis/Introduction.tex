...
% how rigorous do i go with statistics and citing?

In 202x, x0,000 (\textbf{TODO}\%) Irish students progress to college after they graduate from secondary school.
...
This is a daunting question (cite some worry statistic) for many reasons.
For instance, the chosen college course may have a large impact
on a person's future career, which is a significant aspect to a person's life.
As well as this, the majority of Irish college courses have a 3-4 year duration, which is a large time commitment.
The decision also comes with many personally confronting questions such as: 
\emph{"What do I want to do with the rest of my life?", "What do I love doing?"} and
\emph{"What am I good at?"}, among many others.

\cite{amati2002probabilistic}

In 2018, 31\% of recent Irish college graduates reported they were not likely to study their college course again. [](https://hea.ie/statistics/graduate-outcomes-data-and-reports/graduate-outcomes-2018/honours-degree-graduates/)


In addition to this, the majority (cite statistic) of secondary level students are faced with making this decision 
at 16-18 years old, an age with limited life experience, and knowledge about the world and of themself.
...
% "What course should I study?" is a daunting question to people for many reasons. For
% instance, the course an individual pursues could make a huge difference to the rest of their
% life. Moreover, the decision comes with personally confronting questions such as: "What do
% I want to do with the rest of my life?", "What do I love doing?" and "What am I good
% at?", among many others. In Ireland, most second-level students are faced with making that
% decision at around 17 years old, an age with limited life experience and knowledge about the
% world.
% In choosing a college course, an individual is also influenced by a multitude of external
% factors. Parents are shown to be one of the most influential factors on an individual’s college
% course choice [1]. An individual’s gender, socioeconomic status and their family’s
% educational background are among the most prominent societal influences on an individual’s
% college course choice [1].
% The difficulty in choosing a suitable college course is the primary motivation for this research
% topic.
