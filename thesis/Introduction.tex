...
GCs are trained professional in Irish secondary schools, primarily known for assisting students in their career prospects after graduation.
...
signalling a shift in priorities for GCs across Irish secondary schools: vocational support may not be the most important aspect of a GCs role going forward.

% todo? gemini suggests talking about existing technologies to solve this problem
    % ig we'd start with careersportal/qualifax
    % then FMCC?
...
Therefore, this disseration's ability to answer this research question will be measured by its performance on the relevance, diversity and serendipity metrics.
