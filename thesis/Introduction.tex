...
\textbf{todo - might have changed the wording on these, so ctrl+f to double check they are accurate!}
...
\begin{enumerate}
    ...
    \item \label{res-obj-baseline} Design an objective, easily reproducable baseline RS appropriate to the Irish college context.
