...
For instance, in \cite{hea2018graduate}, about 10,000 (31\%) of recent Irish college graduates reported they were not likely to study their college course again, 
and in \cite{roese2005we}, vocational mismatch is documented as a frequent regret for many Americans,
...
we can shift to more of a technological focus. A Recommender System (RS) is a technology that recommends items to a user.
...
\begin{itemize}
    ...
    \item Chapter \ref{chap:evaluation} - Evaluation. This chapter will explain the conducted experiment methodology, and evaluate the RSs performance on various metrics.
