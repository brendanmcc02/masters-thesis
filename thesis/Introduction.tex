...
For example, an effective RS would not suggest 20 different computer science (CS) courses to a user, even if the user has demonstrated 
...
\begin{enumerate}
    ...
    \item \label{res-obj-baseline} Design an objective, easily reproducable baseline RS appropriate to the Irish college course context.
