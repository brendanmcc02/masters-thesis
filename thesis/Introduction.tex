...
As we can see, choosing a college course is a difficult, multi-faceted decision, and the decision is made more challenging 
by the shifting priorities of Irish GC's.
...
potential alleviating the difficulty of the college course decision-making process.
...
and we can further understand the meaning of `assist' by exploring the three qualities of an effective RS, as outlined in \cite{aggarwal2016recommender}, a prominent and popular textbook on RS's:
...
and so we recommend that the reader grows familiar with these concepts.
