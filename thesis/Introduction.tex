...
\begin{enumerate}
    ...
    \item \label{res-obj-information} Identify the relevant information to question a user in order to recommend suitable college courses.
    \item \label{res-obj-baseline} Design a baseline RS appropriate to the Irish college context.
    \item \label{res-obj-statistically} Create a college course RS with statistically significant improvements compared to a baseline RS.
    \item \label{res-obj-insights} Analyse the insights and findings gathered from a conducted experiment.
\end{enumerate}
