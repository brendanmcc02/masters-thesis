...
we are seeking to design an RS that \emph{assists} a user's exploration into college courses
by providing with them \textbf{relevant, diverse} and \textbf{serendipitous} recommendations.
Among the three types of RS's described in section \ref{sec:common-rs-types},
\emph{Collaborative Filtering} (CF) is more likely to provide \textbf{serendipitous}\footnote{According to \url{https://developers.google.com/machine-learning/recommendation/collaborative/summary}}
recommendations.
This is because CF does not solely rely on what the user likes, rather it leverages the data of what \emph{other} similar users also liked, 
...
Honestly speaking, the performance of this model was disappointing as demonstrated through the low recall scores referenced above.
...
In this section, we will provide more insights as to \emph{why} the model with these popular datasets performed poorly.\\
