...
As part of the approach, popular datasets (see footnote \ref{op-dataset}) were utilised that others may use in solving similar problems to this dissertation.
...
A promising dataset in this context was published by OpenPsychometrics\footnote{\label{op-dataset}\url{https://openpsychometrics.org/_rawdata/}} with data on over 140,000 individuals.
