...
top-1 and top-3 accuracy was the Histogram-based Gradient Boosting Classifier (HGBC), with it's implementation details given in listing \ref{lst:hgbm-implementation} below:
