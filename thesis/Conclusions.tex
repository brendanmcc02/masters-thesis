...
\begin{enumerate}
    ...
    \item \emph{Design an objective, easily reproducable baseline RS appropriate to the Irish college course context.}\\A baseline RS that fits this criteria was explicitly described in section \ref{sec:baseline-rs}. We may consider this research objective achieved.
...
contribution to the domain surrounding college and career RS's.
