...
where eight of those recommendations were not on the user's original CAO list, i.e. serendipitous recommendations.
...
just because a student chooses to study biology, does not imply that they like the biology course.
...
This is due to the CF RSs ability to implicitly capture nuanced human interaction that traditional metadata/labeling fails to capture.
