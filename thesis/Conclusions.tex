...
\begin{enumerate}
    ...
    \item \emph{Identify the relevant information an RS should question a user to recommend suitable college courses.}\\The relevant information was identified in subsection \ref{sec:user-information-to-profile-summary}, directly informing the design of this disseration's RS. Thus, we can also consider this research objective achieved.
