...
for course in courses:
    ...
    if "healthcare" in course["categories"] and "investigative" in course["interests"] and "social" not in course["interests"]:
        print(title)
...
#     if "creative arts" in course["categories"] and "conventional" in course["interests"]:
#         print(title)
