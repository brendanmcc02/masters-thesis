...
# write_user_evaluation_to_csv(user_data_part_2, user_timestamp_part_2, actual_college_course_recommendations, baseline_college_course_recommendations)

print(parse_id_and_title_from_cao_college_course("TR033 CS"))
