...
user_riasec_questions_vector = [ 1, 2, 0, 2, 1, 3, 1, 2, # R
                                 3, 3, 3, 1, 1, 1, 1, 1, # I
                                 0, 0, 2, 2, 0, 2, 2, 0, # A
                                 0, 2, 3, 3, 1, 1, 2, 0, # S
                                 3, 1, 1, 2, 2, 1, 3, 0, # E
...
top_k_recommendations = get_top_k_recommendations(filtered_cao_courses, user_riasec_questions_vector, user_college_course_preferences, user_leaving_cert_subject_preferences, k=20, should_reuse_trained_open_psychometrics_model=False)
