...
# dirty_df['major_category'] = dirty_df['major_preprocessed'].apply(get_most_frequently_occuring_college_major_category_with_substring_match, college_majors=college_majors, major_to_major_category_dict=major_to_major_category_dict)
