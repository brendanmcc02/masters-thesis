...
\begin{document}
    ...
    It is very important to note that this RS would not replace the role of GCs, nor will it replace the college course research process that every student must undertake.
    ...
    Both GCs I talked to mentioned that a lot of information can be learned about the student when you ask what LC subjects they like/dislike and why.
    ...
    However, one of the GCs I talked to expressed concerns that Holland codes provide narrow snapshots of the students and can be very limiting.
    ...
    I have not given a lot of thought as to how I would evaluate my RS with GCs, but off the top of my head,
    ...
    to compare the GCs results with my RS' suggestions.
